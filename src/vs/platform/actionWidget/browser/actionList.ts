				...
				getAriaLabel: element => {
					if (element.kind === ActionListItemKind.Action) {
						...
						if (element.hover?.content && !element.ariaDescription && !element.description) {
							...
							const hoverText = typeof hoverContent === 'string' ? hoverContent : isMarkdownString(hoverContent) ? hoverContent.value : hoverContent instanceof HTMLElement ? hoverContent.textContent ?? undefined : undefined;
